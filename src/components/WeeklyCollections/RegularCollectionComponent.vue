<template>
  <q-form ref="formRef" @submit="saveCollection">
    ...
    >
      <div class="text-h6 text-weight-medium">Load Existing Collection</div>
      ...
      <div class="row">
        <div class="col-12 col-sm-4">
          ...
          >
            ...
            <template v-slot:hint> Select a date to load and edit a previous collection </template>
          </q-select>
        </div>
      </div>
    </section>
    ...
    <section
      ...
      :class="{ 'q-mb-lg': $q.screen.width > $q.screen.height, 'q-mb-sm': $q.screen.lt.sm }"
    >
      <div class="text-h6 text-weight-medium">Collection Date</div>
      <q-separator class="q-mb-md"></q-separator>
      <div class="row">
        <div class="col-12 col-sm-4">
    ...
    <section class="form-section">
      <div class="text-h6 text-weight-medium">Service Offerings</div>
      <q-separator class="q-mb-md"></q-separator>
      <ServiceOfferingsRow
    ...
    >
      ...
      <!-- Save Button -->
      <q-btn type="submit" label="Save Collection" color="positive" class="full-width" no-caps />
    </section>
  </q-form>
